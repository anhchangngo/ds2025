...
class FileTransferStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadFile = channel.stream_unary(
                ...
                response_deserializer=file__transfer__pb2.TransferStatus.FromString,
...
def add_FileTransferServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UploadFile': grpc.stream_unary_rpc_method_handler(
                    ...
                    response_serializer=file__transfer__pb2.TransferStatus.SerializeToString,
            ),
    }
...
class FileTransfer(object):
    ...
    def UploadFile(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            file__transfer__pb2.TransferStatus.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
